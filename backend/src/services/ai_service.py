...
_CHAT_STYLE = (
    ...
    "• ТОЛЬКО русский язык и кириллица. Абсолютно ноль других алфавитов — ни латиницы, ни иероглифов, ни арабского. Если видишь иностранное слово — транслитерируй ('контент', 'окей', 'лайк').\n"
